...
### MCP Servers (24/27 OK, tested 2026-02-24)
- **Local (11/12 OK)**: github, memory, sequential-thinking, railway, cloudflare-docs, context7, magic, gmail, desktop-commander, claude-in-chrome, fetch (remplace firecrawl) | ⚠️ filesystem (CWD bug)
